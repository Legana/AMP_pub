...
1. Include all AMPs from the APD, DRAMP and dbAMP databases with lengths >20 AA and < 60 AA
2. Include mature peptides from SwissProt (also with length >20 AA and <60 AA)
