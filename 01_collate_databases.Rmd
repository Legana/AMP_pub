...
df <- data.frame(gr = rep(1:5, 1),
                 val = runif(5, 10,20))

ggplot(df, aes(gr, val)) +
  geom_bar(stat = "identity") +
  geom_ellipse(aes(x0=2, y0= 10,
                   a = .5, b= 10,
                   angle = 0, m1=5,
                   m2=5)) #+
  # geom_ellipse(aes(x0=4, y0=10,
  #                  a= .5, b = 9,
  #                  angle=0,
  #                  m1=2, m2=5))
...
ggsave("additional_stuff/sp_amps_len.png", height = 3, width = 4)
```
