...
In the `ampir` default models we distinguish between those designed to predict protein precursors and those for mature peptides. Positive datasets for both are outlined in [01_collate_databases](01_collate_databases.md).
...
**Step 3 and 4** We read both target and background datasets and apply filters to the background dataset that were also applied to the target dataset:
