...
3. Check that no sequences in the background dataset contain non-standard AA. 
...
**Step 3 and 4** are fairly trivial. Length filters are applied and sequences with non-standard AA removed
