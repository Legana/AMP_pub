...
The training and test set were created in `02_train_test_set.Rmd` and used for training the model that was trained and tuned with `tune_model.R` and `tune_model.sh`.
