...
Rscript tune_model.R outfile=../cache/tuned_precursor_nobench.rds train=../cache/featuresTrain_precursor_nobench.rds test=../cache/featuresTest_precursor_nobench.rds ncores=24